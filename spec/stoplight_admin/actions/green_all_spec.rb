...
RSpec.describe StoplightAdmin::Actions::GreenAll do
  ...
  let(:red_light) { instance_double(StoplightAdmin::LightsRepository::Light, name: 'red-light') }
  let(:yellow_light) { instance_double(StoplightAdmin::LightsRepository::Light, name: 'yellow-light') }
